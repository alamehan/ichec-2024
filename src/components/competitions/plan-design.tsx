...
import { IconArrowScroll, IconDotTimeline, ImgUser1, Box3dCompetitions, Box3dTimeLeft, Box3dRegistration, Box3dContact, OrnamentDashLine, Box3dTheme, ImgDivLogoBigPD } from "../../assets/images/index.tsx";
...
const planDesign = () => {
  ...
  const targetDate = generateTargetDate(2023, 11, 14, 24); // <- Ubah disini
            ...
            <div className={`${css.contentContainer}`}>
              <div className={`${css.layout1Column} ${css.verticalCenter}`}>
                <div className={`row1-col1 ${css.widthFull} ${css.txtCenterToCenter}`}>
                  <img src={ImgDivLogoBigPD} alt="Logo Plan Design" className={`${css.imgReponsive} mb-8 md:mb-12 hover:animate-gelatine`} />
                  <div className='mb-12'>
            ...
            <div className={`${css.contentContainer}`}>
              <div className={`${css.layout1Column}`}>
                <div className={`row2-col1 ${css.txtCenterToCenter}`}>
                  ...
                  <div className={`${css.txtHeadline1} mb-8`}>Plant Design Competition</div>
                  <div className={`${css.txtBody} max-w-[768px] mx-auto`}>The Plant Design Competition aims to develop process design skill or process engineering students by considering process, safety, environmental, and economical aspects.</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className={`${css.contentContainer} box-here`}>
              <div className={`${css.layout1Column}`}>
                <div className={`row3-col1 ${css.txtCenterToCenter} pt-16 pb-20`}>
                  ...
                  <div className={`${css.txtDisplay2White} mx-3 lg:mx-6`}>Designing Innovative Plants for Future Energy Efficiency and Renewable Energy Integration</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={`${css.layout1Column} ${css.verticalCenter}`}>
                <div className={`row6-col1 ${css.widthFull} ${css.txtCenterToCenter}`}>
                  ...
                  <Timeline
                    mode="alternate"
                    items={[
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="14 November 2023" desc="Extended Registration Deadline" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="15 November 2023" desc="Extended Abstract Submission Deadline" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="16 December 2023" desc="Announcement Selected Abstract" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="13 January 2024" desc="Full Paper Submission" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="31 January 2024" desc="Finalist Announcement" /> },
              ...
              <div className={`${css.layout1Column}`}>
                <div className={`row8-col1 ${css.txtCenterToCenter}`}>
                  <div className='hover:animate-bounce'>
                    <Link to="https://docs.google.com/forms/d/e/1FAIpQLSfHe0poturJKQgam27WQyhMH7rV7D3i-O79DZN2m1u_4EQlDQ/viewform?usp=sharing" className="btn-gradient" onMouseOver={playSoundPop} onClick={playSoundClick}>Register Now</Link>
                  </div>
                </div>
              </div>
            </div>
