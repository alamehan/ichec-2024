...
import { IconArrowScroll, IconDotTimeline, ImgUser1, Box3dCompetitions, Box3dTimeLeft, Box3dRegistration, Box3dContact, OrnamentDashLine, Box3dTheme, ImgDivLogoBigPS } from "../../assets/images/index.tsx";
...
const problemSolving = () => {
  ...
  const targetDate = generateTargetDate(2023, 11, 13, 24); // <- Ubah disini
            ...
            <div className={`${css.contentContainer}`}>
              <div className={`${css.layout1Column} ${css.verticalCenter}`}>
                <div className={`row1-col1 ${css.widthFull} ${css.txtCenterToCenter}`}>
                  <img src={ImgDivLogoBigPS} alt="Logo Problem Solving" className={`${css.imgReponsive} mb-8 md:mb-12 hover:animate-gelatine`} />
                  <div className='mb-12'>
            ...
            <div className={`${css.contentContainer}`}>
              <div className={`${css.layout1Column}`}>
                <div className={`row2-col1 ${css.txtCenterToCenter}`}>
                  ...
                  <div className={`${css.txtHeadline1} mb-8`}>Problem Solving Competition</div>
                  <div className={`${css.txtBody} max-w-[768px] mx-auto`}>The Problem Solving Competition aims to challenge the participants proficiency in solving a specific industrial plant problem and propose their innovative ideas as solutions.</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className={`${css.contentContainer} box-here`}>
              <div className={`${css.layout1Column}`}>
                <div className={`row3-col1 ${css.txtCenterToCenter} pt-16 pb-20`}>
                  ...
                  <div className={`${css.txtDisplay2White} mx-3 lg:mx-6`}>Reduction of CO2 Emissions in Clean Hydrogen Production</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={`${css.layout1Column} ${css.verticalCenter}`}>
                <div className={`row6-col1 ${css.widthFull} ${css.txtCenterToCenter}`}>
                  ...
                  <Timeline
                    mode="alternate"
                    items={[
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="13 November 2023" desc="Extended Registration Deadline" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="18 November 2023" desc="Extended Abstract Submission Deadline" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="3 December 2023" desc="Announcement Selected Abstract" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="6 January 2024" desc="Full Paper Submision" /> },
                      { dot: <img src={IconDotTimeline}></img>, children: <TimelineData date="27 January 2024" desc="Finalist Announcement" /> },
              ...
              <div className={`${css.layout1Column}`}>
                <div className={`row8-col1 ${css.txtCenterToCenter}`}>
                  <div className='hover:animate-bounce'>
                    <Link to="https://docs.google.com/forms/d/e/1FAIpQLSdEXdNbiMcC4_ND3Aw0ny-mbsoe_UNtFu2TddmHxwSwQQ_Cmw/viewform?usp=sharing" className="btn-gradient" onMouseOver={playSoundPop} onClick={playSoundClick}>Register Now</Link>
                  </div>
                </div>
              </div>
            </div>
